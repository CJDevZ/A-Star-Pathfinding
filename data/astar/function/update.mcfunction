...
execute facing entity @n[type=marker,tag=astar.end] eyes rotated ~ 0 positioned ^ ^ ^0.708 align xyz positioned ~.5 ~.5 ~.5 if predicate astar:diagonal run scoreboard players add new astar.g 4
